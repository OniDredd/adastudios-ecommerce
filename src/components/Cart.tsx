      ...
      <AnimatePresence>
        {isCartOpen && (
          <motion.div 
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-main-maroon/60 backdrop-blur-sm z-[998]"
            onClick={closeCart}
          />
        )}
      </AnimatePresence>
            ...
            <div className="border-t border-gray-200 bg-white px-6 py-4">
              ...
              <div className="space-y-2 mb-4">
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-main-maroon">${subtotal.toFixed(2)}</span>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm text-gray-500 mb-4">
                  ...
                  <span>${(subtotal / 4).toFixed(2)} with Afterpay</span>
                </div>
