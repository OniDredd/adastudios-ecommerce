        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 py-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/collections/all" className="opacity-100 hover:opacity-60 transition-opacity duration-200">Shop All</Link></li>
              <li><Link href="/collections/new-arrivals" className="opacity-100 hover:opacity-60 transition-opacity duration-200">Matcha</Link></li>
              <li><Link href="/collections/best-sellers" className="opacity-100 hover:opacity-60 transition-opacity duration-200">Glasses</Link></li>
              <li><Link href="/collections/wine-glasses" className="opacity-100 hover:opacity-60 transition-opacity duration-200">Accessories</Link></li>
              <li><Link href="/sale" className="opacity-100 hover:opacity-60 transition-opacity duration-200">Sale</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/size-guide" className="opacity-100 hover:opacity-60 transition-opacity duration-200">Size Guide</Link></li>
