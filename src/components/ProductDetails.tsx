...
export default function ProductDetails({ product, collection }: ProductDetailsProps) {
  ...
  return (
    <div className="flex flex-col md:flex-row h-full md:divide-x md:divide-[0.5px] divide-main-maroon">
      ...
      >
        <div className="w-full h-full flex justify-center items-centers sm:py-10 px-10 md:px-16 overflow-y-auto">
          <div className="max-w-xl mx-auto space-y-3 md:space-y-4 md:min-h-screen flex flex-col sm:pt-16 md:pt-32">
            {/* Header */}
